  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <span className="bg-[#7B1E1E]/10 text-[#7B1E1E] dark:text-[#C79A2D] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
          {'2850+ विद्यालय नेटवर्क'}
        </span>
        <h1 className="font-playfair text-3xl sm:text-5xl font-bold text-gray-900 dark:text-white">
          {'सहयोगी एवं अग्रणी विद्यालय'}
        </h1>
        <p className="text-sm text-gray-600 dark:text-gray-300">
          {'देश के शीर्ष सीबीएसई, आईसीएसई एवं राज्य बोर्ड विद्यालय जो भाषा ओलंपियाड से संबद्ध हैं'}
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {PARTNER_SCHOOLS.map(sc => <div key={sc.id} className="bg-white dark:bg-[#1A1414] p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-md space-y-3">
      ...
      <div className="bg-gradient-to-r from-[#7B1E1E] to-[#A32A2A] text-white p-8 sm:p-10 rounded-3xl text-center space-y-4">
        <h2 className="font-playfair text-2xl font-bold">
          {'क्या आपका विद्यालय अभी तक पंजीकृत नहीं है?'}
        </h2>
        <p className="text-xs text-gray-200 max-w-xl mx-auto">
          {'अपने विद्यालय के विद्यार्थियों को राष्ट्रीय मंच प्रदान करने हेतु आज ही विद्यालय ऑनलाइन आवेदन पत्र भरें।'}
        </p>
        <button onClick={() => navigateTo('/registration')} className="bg-[#C79A2D] text-[#7B1E1E] font-bold px-8 py-3 rounded-2xl text-xs shadow-lg hover:bg-[#E2B855] transition-colors">
          {'विद्यालय पंजीकरण हेतु क्लिक करें'}
        </button>
      </div>
