  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="bg-gradient-to-r from-[#1A1414] to-[#3D2626] text-white rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden border border-[#C79A2D]/30">
        <div className="max-w-3xl space-y-4">
          ...
          <h1 className="font-playfair text-3xl sm:text-5xl font-bold text-[#C79A2D]">
            {'राष्ट्रीय संस्कृत भाषा ओलंपियाड 2026'}
          </h1>
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            <button onClick={() => navigateTo('/registration')} className="bg-[#C79A2D] text-[#7B1E1E] font-bold px-6 py-3 rounded-xl text-xs hover:bg-[#E2B855] transition-colors">
              {'संस्कृत ओलंपियाड हेतु पंजीकरण करें'}
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-[#1A1414] p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-2">
          ...
          <h3 className="font-bold text-sm text-gray-900 dark:text-white">{'संस्कृत परीक्षा तिथि'}</h3>
        ...
        <div className="bg-white dark:bg-[#1A1414] p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm space-y-2">
          ...
          <h3 className="font-bold text-sm text-gray-900 dark:text-white">{'विशेष संस्कृत छात्रवृत्ति'}</h3>
