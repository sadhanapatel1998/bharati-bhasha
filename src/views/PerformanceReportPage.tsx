  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      <div className="text-center max-w-2xl mx-auto space-y-4">
        ...
        <h1 className="font-playfair text-3xl sm:text-5xl font-bold text-gray-900 dark:text-white">
          {'बेंचमार्क रिपोर्ट व स्कोर कार्ड'}
        </h1>
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
          {'अनुक्रमांक दर्ज कर अपना 12-आयामी रिपोर्ट कार्ड व ई-सर्टिफिकेट देखें'}
        </p>
      </div>
      ...
      <div className="max-w-xl mx-auto bg-white dark:bg-[#1A1414] p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl">
        <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-1">
            ...
            <input type="text" value={inputRollNumber} onChange={e => setInputRollNumber(e.target.value)} placeholder="e.g. BBO2026-9842" className="w-full pl-11 pr-4 py-3 rounded-2xl bg-gray-50 dark:bg-gray-800 text-sm font-bold text-gray-900 dark:text-white border border-gray-200 dark:border-gray-700 focus:outline-none focus:border-[#C79A2D]" />
          </div>
          <button type="submit" className="bg-[#7B1E1E] hover:bg-[#541313] text-white px-6 py-3 rounded-2xl font-bold text-xs shadow-md transition-colors shrink-0">
            {'परिणाम खोजें'}
          </button>
        </form>
      ...
      {report && <div className="max-w-4xl mx-auto bg-white dark:bg-[#1A1414] rounded-3xl p-6 sm:p-10 border-2 border-[#C79A2D]/30 shadow-2xl space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div className="p-4 rounded-2xl bg-[#7B1E1E]/5 dark:bg-white/5 border border-[#7B1E1E]/10 space-y-1">
              ...
              <div className="text-[11px] font-medium text-gray-500">{'प्राप्तांक'}</div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#C79A2D]/10 border border-[#C79A2D]/20 space-y-1">
              ...
              <div className="text-[11px] font-medium text-gray-500">{'राष्ट्रीय पर्सेंटाइल'}</div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#2E8B57]/10 border border-[#2E8B57]/20 space-y-1">
              ...
              <div className="text-[11px] font-medium text-gray-500">{'राष्ट्रीय रैंक'}</div>
            </div>

            <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/20 space-y-1">
              <div className="text-2xl font-extrabold text-amber-600">#{report.stateRank}</div>
              <div className="text-[11px] font-medium text-gray-500">{'राज्य स्तरीय रैंक'}</div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="font-bold text-sm text-gray-900 dark:text-white flex items-center gap-2">
              ...
              <span>{'विषयवार दक्षता विभाजन (Category Scores)'}</span>
            </h3>
            ...
            <div className="space-y-3 text-xs">
              <div>
                ...
                <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                  <div className="bg-[#7B1E1E] h-2.5 rounded-full" style={{
                width: `${report.categoryScores.grammar / 30 * 100}%`
              }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                  <div className="bg-[#C79A2D] h-2.5 rounded-full" style={{
                width: `${report.categoryScores.literature / 25 * 100}%`
              }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-full h-2.5 overflow-hidden">
                  <div className="bg-[#2E8B57] h-2.5 rounded-full" style={{
                width: `${report.categoryScores.vocabulary / 25 * 100}%`
              }}></div>
                </div>
              </div>
              ...
              <div>
                ...
                width: `${report.categoryScores.comprehension / 20 * 100}%`
              }}></div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            <div className="p-4 rounded-2xl bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 space-y-2">
              <h4 className="font-bold text-xs text-[#2E8B57] flex items-center gap-1.5">
                ...
                <span>{'मुख्य सामर्थ्य क्षेत्र (Strengths)'}</span>
              </h4>
            ...
            <div className="p-4 rounded-2xl bg-amber-50/50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 space-y-2">
              <h4 className="font-bold text-xs text-amber-700 dark:text-amber-400 flex items-center gap-1.5">
                ...
                <span>{'सुधार के अवसर (Growth Areas)'}</span>
              </h4>
              <ul className="space-y-1 text-xs text-gray-600 dark:text-gray-300">
                {report.areasForImprovement.map((imp, i) => <li key={i}>• {imp}</li>)}
              </ul>
            </div>
          </div>
          ...
          <div className="pt-4 border-t border-gray-100 dark:border-gray-800 flex flex-wrap items-center justify-between gap-4">
            <button onClick={() => window.print()} className="bg-gray-900 hover:bg-black text-white px-5 py-2.5 rounded-xl text-xs font-bold transition-colors flex items-center gap-2">
              <Printer className="w-4 h-4" />
              <span>{'रिपोर्ट कार्ड प्रिंट करें'}</span>
            </button>

            <button onClick={() => showToast('डिजिटल प्रमाण पत्र डाउनलोड प्रारम्भ हुआ।', 'success')} className="bg-[#C79A2D] hover:bg-[#E2B855] text-[#7B1E1E] px-6 py-2.5 rounded-xl text-xs font-bold shadow-md transition-colors flex items-center gap-2">
              <Download className="w-4 h-4" />
              <span>{'ई-प्रमाण पत्र डाउनलोड (PDF)'}</span>
            </button>
          </div>
