  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <span className="bg-[#C79A2D]/10 text-[#C79A2D] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider">
          {'राष्ट्रीय स्तर सम्मान'}
        </span>
        <h1 className="font-playfair text-3xl sm:text-5xl font-bold text-gray-900 dark:text-white">
          {'राष्ट्रीय पुरस्कार एवं छात्रवृत्ति'}
        </h1>
        <p className="text-sm text-gray-600 dark:text-gray-300">
          {'विज्ञान भवन नई दिल्ली में आयोजित भव्य राष्ट्रीय समारोह में ₹1 करोड़ मूल्य के पुरस्कार'}
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {AWARDS_LIST.map(aw => <div key={aw.id} className="bg-white dark:bg-[#1A1414] rounded-3xl p-6 border border-gray-100 dark:border-gray-800 shadow-xl space-y-4 flex flex-col justify-between">
            <div>
              ...
              <ul className="mt-3 space-y-1.5 text-xs text-gray-600 dark:text-gray-400">
                {aw.perks.map((perk, i) => <li key={i} className="flex items-start gap-1.5">
