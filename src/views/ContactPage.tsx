          ...
          <div className="bg-white dark:bg-[#1A1414] p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-md space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-gray-900 dark:text-white">{'राष्ट्रीय कार्यालय पता'}</h4>
            ...
            <div className="flex items-start gap-4 pt-2">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-gray-900 dark:text-white">{'हेल्पलाइन नंबर'}</h4>
            ...
            <div className="flex items-start gap-4 pt-2">
              ...
              <div className="text-xs">
                <h4 className="font-bold text-gray-900 dark:text-white">{'ईमेल आईडी'}</h4>
        ...
        <div className="lg:col-span-7 bg-white dark:bg-[#1A1414] p-8 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-4 text-xs">
            ...
            <div className="space-y-1">
              ...
              <textarea rows={4} required value={formData.message} onChange={e => setFormData({
              ...formData,
              message: e.target.value
            })} placeholder="Write your query details here..." className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:outline-none focus:border-[#C79A2D]" />
            </div>

            <button type="submit" className="bg-[#7B1E1E] text-white px-8 py-3 rounded-xl font-bold text-xs shadow-md flex items-center gap-2">
