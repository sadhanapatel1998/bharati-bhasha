        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="bg-gradient-to-r from-[#790e03] to-[#A32A2A] hover:from-[#541313] hover:to-[#790e03] text-[#F5F0E6] px-5 pt-4 pb-3 rounded-xl text-medium font-semibold shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 glow-gold"
            >
            ...
            {isRegisterOpen && (
              <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-[#1A1414] rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 p-2 z-50 glass-panel">
                ...
                >
                  ...
                  <div>
                    <div className="text-gray-900 dark:text-white font-bold">
                      {language === 'hi' ? 'विद्यालय पंजीकरण' : 'School Registration'}
                    </div>
                ...
                >
                  ...
                  <div>
                    <div className="text-gray-900 dark:text-white font-bold">
                      {language === 'hi' ? 'व्यक्तिगत छात्र पंजीकरण' : 'Student Registration'}
                    </div>
                    <div className="text-[12px] text-gray-500">
                      {language === 'hi' ? 'कक्षा 1 से 12 तक के छात्र' : 'Individual online exam'}
                    </div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <div className="text-gray-900 dark:text-white font-bold">
                      {language === 'hi' ? 'शिक्षक / संयोजक' : 'Teacher / Coordinator'}
                    </div>
                    <div className="text-[12px] text-gray-500">
                      {language === 'hi' ? 'भाषा शिक्षक पंजीकरण व सम्मान' : 'Language teacher registration'}
                    </div>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <div className="font-extrabold">
                      {language === 'hi' ? 'प्रशासनिक लॉगिन (Admin)' : 'Admin Login'}
                    </div>
                    <div className="text-[12px] text-gray-500">
                      {language === 'hi' ? 'स्कूल व परीक्षा नियंत्रण कक्ष' : 'School & exam dashboard'}
                    </div>
                  </div>
                </button>
              </div>
