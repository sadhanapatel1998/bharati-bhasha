...
export const IndiaMapInteractive: React.FC = () => {
  ...
  return <div className="bg-white dark:bg-[#1A1414] rounded-3xl p-6 sm:p-10 shadow-xl border border-gray-100 dark:border-gray-800">
      ...
      <div className="text-center max-w-2xl mx-auto mb-10">
        ...
        <h3 className="font-playfair text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">
          {'भारत के 28 राज्यों में व्यापक उपस्थिति'}
        </h3>
        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-2">
          {'4.5 लाख से अधिक छात्रों एवं 2,850+ विद्यालयों का अटूट विश्वास'}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          return <button key={idx} onClick={() => setSelectedState(st)} className={`p-4 rounded-2xl text-left transition-all border ${isSelected ? 'bg-[#7B1E1E] text-white border-[#C79A2D] shadow-lg scale-[1.02]' : 'bg-gray-50 dark:bg-gray-800/50 text-gray-800 dark:text-gray-200 border-gray-100 dark:border-gray-700 hover:border-[#C79A2D]/50'}`}>
                ...
                <div className="grid grid-cols-2 gap-2 text-[11px] opacity-90 mt-2">
                  <div>
                    <span className="block text-[10px] opacity-75">{'छात्र सहभागिता'}</span>
                    <span className="font-bold">{st.studentsCount.toLocaleString()}+</span>
                  </div>
                  <div>
                    <span className="block text-[10px] opacity-75">{'विद्यालय'}</span>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 bg-white/10 p-3.5 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-300">{'कुल पंजीकृत छात्र'}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/10 p-3.5 rounded-2xl border border-white/10">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-300">{'सहयोगी सीबीएससी व आईसीएसई विद्यालय'}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white/10 p-3.5 rounded-2xl border border-white/10">
                ...
                <div>
                  <div className="text-xl font-bold text-white">{selectedState.rank1Count} {'राष्ट्रीय स्वर्ण पदक विजेता'}</div>
                  <div className="text-xs text-gray-300">{'विज्ञान भवन दिल्ली में सम्मानित'}</div>
                </div>
              </div>
            </div>

            <div className="pt-2 text-center text-xs text-gray-300 italic">
              {'क्या आपका विद्यालय अभी तक पंजीकृत नहीं है? आज ही विद्यालय कोड प्राप्त करें।'}
            </div>
          </div>
        </div>
