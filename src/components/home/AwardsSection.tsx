  ...
  return <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center max-w-2xl mx-auto mb-12">
        ...
        <h2 className="font-playfair text-3xl font-bold text-gray-900 dark:text-white mt-1">
          {'राष्ट्रीय पुरस्कार एवं छात्रवृत्ति योजना 2026'}
        </h2>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {AWARDS_LIST.map(aw => <div key={aw.id} className="bg-white dark:bg-[#1A1414] rounded-3xl p-6 border border-gray-100 dark:border-gray-800 shadow-md hover:shadow-2xl transition-all space-y-4 flex flex-col justify-between">
            <div>
